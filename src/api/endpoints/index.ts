...
console.log('AUTH_GW_BASE_URL', process.env.REACT_APP_AUTH_GW_BASE_URL);
console.log('USER_API_BASE_URL', process.env.REACT_APP_USER_API_BASE_URL);
console.log(
  'EXT_REGISTRATION_SERVICE_URL',
  process.env.REACT_APP_EXT_REGISTRATION_SERVICE_URL
);
