...
export const TMT_API_URL =
  process.env.REACT_APP_TMT_API_URL ||
  'https://v2xw5b7nhqkduxcw6v56pas5yy0livjb.lambda-url.eu-north-1.on.aws/testbed/productizers/find-job-postings';
